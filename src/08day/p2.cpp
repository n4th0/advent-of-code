...
int main(){
        ...
        for (unsigned j = 0; j<antenas[i].positions.size(); j++) {
            for (unsigned k = 0; k<antenas[i].positions.size(); k++) {
                if (j != k) {
                    ...
                    Position a;
                    a.y = antenas[i].positions[j].x;
                    a.x = antenas[i].positions[j].y;
                    a.y += x;
                    a.x += y;
                    while (isPositionInRange(a, vect)) {
                        nodes.push_back(a);
                        a.y += x;
                        a.x += y;
                    }
                    ...
                    Position b;
                    b.y = antenas[i].positions[k].x;
                    b.x = antenas[i].positions[k].y;
                    b.y -=  x;
                    b.x -=  y;
                    while (isPositionInRange(b, vect)) {
                        nodes.push_back(b);
                        b.y -=  x;
                        b.x -=  y;
                    }
    ...
    // i should put it unique values but it could be a bit more 
    // inneficient idk 
    ...
    for (unsigned i = 0; i<antenas.size(); i++) {
        count+= antenas[i].positions.size();
    }
